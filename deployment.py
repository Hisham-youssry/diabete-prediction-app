...
if choose == "Home":
    ...
    Urea = st.number_input("Urea (mg/dL):", min_value=0, step=0.10)
    Cr = st.number_input("Creatinine (Cr) (mg/dL):", min_value=0, step=0.10)
    HbA1c = st.number_input("HbA1c (%):", min_value=0, step=0.10)

    st.markdown("#### 💉 Fats")
    Chol = st.number_input("Chol (mg/dL):", min_value=0, step=0.01)
    TG = st.number_input("Triglycerides (TG) (mg/dL):", min_value=0, step=0.10)
    HDL = st.number_input("Good cholesterol (HDL) (mg/dL):", min_value=0, step=0.10)
    LDL = st.number_input("Bad cholesterol (LDL) (mg/dL):", min_value=0, step=0.10)
    VLDL = st.number_input("VLDL (mg/dL):", min_value=0, step=0.10)

    st.markdown("#### ⚖️ Mass measures")
    BMI = st.number_input("Body mass index (BMI):", min_value=0, step=0.10)
